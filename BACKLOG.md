...
> *"Como cliente autenticado, quero ver o cardápio e montar meu lámen."*
...
> *"Como cliente, quero ver meus pedidos anteriores e gerenciar minha conta."*
...
> *"Como desenvolvedor, quero proteger as rotas da aplicação garantindo que apenas usuários com as permissões corretas acessem as páginas."*
...
> *"Como administrador, quero listar, criar, editar e excluir caldos e proteínas do sistema."*
...
> *"Como administrador, quero fazer upload das artes (SVGs) dos ingredientes diretamente pelo painel."*
- [ ] Criar componente de *Dropzone* (ou input file) nos formulários de criação/edição de ingredientes.
...
> *"Como administrador, quero ver todos os pedidos dos clientes e atualizar o status deles em tempo real."*
...
> *"Como usuário, quero saber imediatamente se digitei uma senha errada ou se tentei acessar algo que não devo."*
